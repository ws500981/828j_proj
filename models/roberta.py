...
class RobertaModel(object):
    def __init__(self,train_loader, val_loader, bert_name):
        ...
        self.model = RobertaForSequenceClassification.from_pretrained(bert_name, num_labels=2)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            checkpoint_path = os.path.join(checkpoint_dir, f"roberta_checkpoint_epoch{epoch}.pth")
            checkpoint = {
                'epoch': epoch,
...
if __name__ == "__main__":
    ...
    bert_name = 'FacebookAI/roberta-large'
    ...
    obj = RobertaModel(train_loader, val_loader, bert_name)
    obj.train()