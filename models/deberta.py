...
class DebertaModel(object):
    def __init__(self,train_loader, val_loader, bert_name):
        super(DebertaModel, self).__init__()
        self.train_loader = train_loader
        self.val_loader = val_loader
        self.model = DebertaForSequenceClassification.from_pretrained(bert_name, num_labels=2)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            checkpoint_path = os.path.join(checkpoint_dir, f"deberta_checkpoint_epoch{epoch}.pth")
            checkpoint = {
                'epoch': epoch,
...
if __name__ == "__main__":
    ...
    bert_name = 'microsoft/deberta-base'
    ...
    obj = DebertaModel(train_loader, val_loader, bert_name)
    obj.train()